        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockDocuments_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemAttributes", x => new { x.ItemId, x.AttributeValueId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehouseStocks", x => new { x.WarehouseId, x.ItemId });
                    table.CheckConstraint("CK_WarehouseStocks_Quantity", "[Quantity] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_StockDocuments_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockDocumentDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockDocumentDetails_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockDocumentDetails_StockDocuments_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "StockDocuments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "Address", "Code", "CustomerType", "Debt", "IsActive", "Name", "Phone", "TaxCode" },
                values: new object[] { 1, null, "KHACH-LE", 1, 0m, true, "Khách lẻ", null, null });

            migrationBuilder.InsertData(
                table: "Warehouses",
                columns: new[] { "Id", "Address", "Code", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, null, "KHO-A", true, "Kho A" },
                    { 2, null, "KHO-B", true, "Kho B" },
                    { 3, null, "KHO-C", true, "Kho C" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockDocumentDetails_DocumentId",
                table: "StockDocumentDetails",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_StockDocumentDetails_ItemId",
                table: "StockDocumentDetails",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_StockDocuments_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockDocuments_DocumentType_Status_DocumentDate",
                table: "StockDocuments",
                columns: new[] { "DocumentType", "Status", "DocumentDate" });
